...
def payment_success_view(request):
    ...
    user_payment=models.UserPayment(app_user= request.user,stripe_checkout_id=checkout_session_id,payment_bool=True)
    user_payment.save();
    response = render(request,"ecom/payment_successful.html")
    response.delete_cookie('product_ids')
    response.delete_cookie('email')
    response.delete_cookie('mobile')
    response.delete_cookie('address')
...
def payment_cancelled_view(request):
    stripe.api_key=settings.STRIPE_SECRET_KEY
    return render(request,"ecom/payment_cancelled.html")
